#' Aggregate files for single sample results that used all but 4 cells
...
singlesample_data_path <- file.path(path, "singlesample_output_onlyinteract")
...
# Aggregate files
if(file.exists(file.path(processed_data_path, "single_sample_subset_cells_perfsummary_onlyinteract.rds"))){
  summary_out_all <- readRDS(file.path(processed_data_path, "single_sample_subset_cells_perfsummary_onlyinteract.rds"))
}else{
  ...
  saveRDS(summary_out_all, file.path(processed_data_path, "single_sample_subset_cells_perfsummary_onlyinteract.rds"))
}
